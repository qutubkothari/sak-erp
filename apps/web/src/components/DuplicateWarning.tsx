...
export function useDuplicateDetection() {
  ...
  const checkDuplicates = async (
    ...
    try {
      ...
      // A failed duplicate check must never leave the user staring at a button
      // that appears to do nothing; surface it and stop instead of throwing
      // an unhandled rejection the caller never sees.
      toast.error(error?.message || 'Unable to check for duplicates. Please try again.');
      return false;
    }
