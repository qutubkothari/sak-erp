...
function QualityPageContent() {
  ...
  return (
    <div className="mx-auto max-w-[1500px] space-y-5 p-4 sm:p-6">
      <div className="rounded-2xl bg-gradient-to-r from-[#455F82] to-[#6C89AE] p-6 text-white">
        <p className="text-xs font-bold uppercase tracking-wider text-blue-100">
          Quality control
        </p>
        <div className="mt-1 flex flex-wrap items-start justify-between gap-3">
          <div>
            <h1 className="text-2xl font-bold">Quality Workbench</h1>
            <p className="mt-1 text-sm text-blue-50">
              Inspect what arrived or was produced, decide its disposition, and
              follow any quality issue to closure.
            </p>
          </div>
      ...
      <section className="rounded-xl border border-[#D7E1EF] bg-white p-3">
        ...
        <div className="flex flex-wrap gap-2">
          {(
            [
              ...
              ["ncr", "Quality issues (NCR)"],
              ["vendors", "Supplier quality"],
            ...
            <button
              ...
              className={`rounded-lg px-4 py-2 text-sm font-semibold ${activeTab === tab ? "bg-[#455F82] text-white" : "border border-[#D7E1EF] text-[#455F82]"}`}
            >
              {title}
            </button>
          ))}
      ...
      <div className="mb-6 flex flex-wrap items-center justify-between gap-2 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm">
        ...
        <span className="text-xs text-amber-800">
          Choose a workspace above; only the relevant detail is shown.
        </span>
      </div>
          ...
          <section className="grid gap-3 md:grid-cols-2">
            <article className="rounded-xl border border-emerald-200 bg-emerald-50 p-4">
              ...
              <h2 className="mt-1 font-bold text-emerald-950">
                Inspect a receipt or production output
              </h2>
              <p className="mt-1 text-sm text-emerald-900">
                Select the UID, record accepted or rejected quantity, and let
                Mizantra control the stock release.
              </p>
              {canCreate ? (
                <button
                  type="button"
            ...
            <article className="rounded-xl border border-red-200 bg-red-50 p-4">
              ...
              <h2 className="mt-1 font-bold text-red-950">
                Record a quality issue
              </h2>
              <p className="mt-1 text-sm text-red-900">
                Create an NCR only when a defect, hold, or non-conformance needs
...
export default function QualityPage() {
  return (
    <Suspense
      fallback={<div className="p-6">Loading Quality workspace...</div>}
    >
      <QualityPageContent />
    </Suspense>
  );
