...
Object.defineProperty(exports, "QuotePdfService", {
    enumerable: true,
    get: function() {
...
let QuotePdfService = class QuotePdfService {
    async renderQuotePdf(input) {
        ...
        const font = await pdfDoc.embedFont(_pdflib.StandardFonts.Helvetica);
        const fontBold = await pdfDoc.embedFont(_pdflib.StandardFonts.HelveticaBold);
        // A4 size in points (72 dpi)
        const PAGE_W = 595.28;
        const PAGE_H = 841.89;
        const brand = {
            dark: (0, _pdflib.rgb)(0.05, 0.12, 0.25),
            accent: (0, _pdflib.rgb)(0.85, 0.55, 0.05),
            light: (0, _pdflib.rgb)(0.97, 0.97, 0.98),
            text: (0, _pdflib.rgb)(0.12, 0.12, 0.14),
            muted: (0, _pdflib.rgb)(0.45, 0.45, 0.5),
            border: (0, _pdflib.rgb)(0.87, 0.87, 0.9)
        };
        ...
        const drawTableHeader = (page, y)=>{
            ...
            page.drawRectangle({
                ...
                width: w,
                height: 24,
                color: (0, _pdflib.rgb)(0.93, 0.93, 0.95)
            });
            page.drawLine({
                start: {
                    x: x0,
        ...
        const rightX = x0 + w;
        const drawKV = (label, value, line, bold = false)=>{
