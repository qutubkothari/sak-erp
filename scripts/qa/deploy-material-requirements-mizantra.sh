...
stage=/tmp/mizantra-material-requirements-20260906-v1
release=material-requirements-20260906
page=apps/web/src/app/dashboard/production/mrp/page.tsx
...
for _ in $(seq 1 40); do
  status=$(curl -s -o /dev/null -w '%{http_code}' http://127.0.0.1:3001/dashboard/production/mrp || true)
  [[ "$status" == "200" ]] && break
  sleep 2
done
[[ "$status" == "200" ]]
