...
stage=/tmp/mizantra-siv-focused-flow-20260906-v1
release=siv-focused-flow-20260906
page=apps/web/src/app/dashboard/inventory/siv/page.tsx
...
for _ in $(seq 1 40); do
  status=$(curl -s -o /dev/null -w '%{http_code}' http://127.0.0.1:3001/dashboard/inventory/siv || true)
  [[ "$status" == 200 ]] && break
  sleep 2
done
[[ "$status" == 200 ]]
