  ...
  async create(tenantId: string, data: any) {
    ...
    const { data: vendor, error } = await this.supabase
      ...
      .insert({
        ...
        shipping_street: data.sameAsbilling ? data.street : data.shippingStreet,
        shipping_city: data.sameAsbilling ? data.city : data.shippingCity,
        shipping_state: data.sameAsbilling ? data.state : data.shippingState,
