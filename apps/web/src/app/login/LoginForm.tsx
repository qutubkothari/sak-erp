            ...
            <div>
              <div className="mb-8">
                <div className="flex items-center gap-4">
                  <img src={brand.logoSrc} alt={brand.logoAlt} className="h-20 w-20 object-contain" />
                  <span className="font-serif text-3xl font-semibold text-[#273b73]">{brand.companyName}</span>
                </div>
              ...
              <div className="rounded-xl border border-[#e3d4b9] bg-white p-5">
                ...
                <p className="mt-2 text-lg font-black">{brand.systemLabel}</p>
              ...
              <div className="flex items-center gap-3">
                <div>
                  <div className="flex items-center gap-2">
                    <img src={brand.logoSrc} alt={brand.logoAlt} className="h-12 w-12 object-contain" />
                    <span className="font-serif text-xl font-semibold text-[#273b73]">{brand.companyName}</span>
                  </div>
                  <p className="mt-2 text-xs font-bold uppercase tracking-[0.16em] text-[#8b6f47]">{brand.systemLabel}</p>
                </div>
              </div>
