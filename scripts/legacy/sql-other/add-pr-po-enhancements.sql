...
CREATE TABLE IF NOT EXISTS rfq_items (
    ...
    vendor_discount_percent DECIMAL(7,3) NOT NULL DEFAULT 0 CHECK (vendor_discount_percent BETWEEN 0 AND 100),
    vendor_gst_percent DECIMAL(7,3) NOT NULL DEFAULT 0 CHECK (vendor_gst_percent BETWEEN 0 AND 100),
