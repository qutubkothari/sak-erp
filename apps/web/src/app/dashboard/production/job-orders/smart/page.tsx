    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          {loadingPreview && (
            <div className="mt-6 p-6 rounded-lg border border-orange-200 bg-orange-50">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-lg font-semibold text-orange-900">{loadingMessage}</span>
                  <span className="text-sm font-medium text-orange-700">{loadingProgress}%</span>
                </div>
                <div className="w-full bg-orange-100 rounded-full h-3 overflow-hidden">
                  <div
                    className="bg-gradient-to-r from-orange-500 to-orange-600 h-3 rounded-full transition-all duration-500 ease-linear"
