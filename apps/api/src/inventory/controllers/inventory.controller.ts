...
export class InventoryController {
  ...
  async getItems(
    ...
    const normalizedScope = String(scope || department || "")
      .trim()
      .toUpperCase();
    const onlyRndBool =
      onlyRnd === "true" ||
  ...
  async sendLowStockEmail(
    @Request() req: any,
    @Body() emailData: { recipientEmail: string },
  ) {
    return this.inventoryService.sendLowStockEmail(
      req,
  ...
  @RequireUpdate("items")
  async ignoreLowStockItem(
    @Request() req: any,
    @Param("itemId") itemId: string,
    @Body() body: any,
  ) {
    return this.inventoryService.setLowStockPlanningIgnored(req, itemId, {
      ...body,
      ignored: true,
    });
  }
  ...
  async createLowStockPurchaseRequisitions(
    @Request() req: any,
    @Body() body: any,
  ) {
  ...
  async convertDemoToSale(
    ...
    return this.inventoryService.convertDemoToSale(
      req,
      demoId,
      body.sales_order_id,
    );
  ...
  @Post("items/:id/drawings/upload-url")
  async prepareItemDrawingUpload(
    @Request() req: any,
    @Param("id") itemId: string,
    @Body() drawingData: any,
  ) {
    return this.itemsService.prepareDrawingUpload(
      req.user.tenantId,
      itemId,
      drawingData,
    );
  ...
  @Get("items/:id/drawings/:drawingId/file-url")
  async getItemDrawingFileUrl(
    @Request() req: any,
    @Param("id") itemId: string,
    @Param("drawingId") drawingId: string,
    @Query("download") download?: string,
  ) {
    return this.itemsService.getDrawingFileUrl(
      req.user.tenantId,
      itemId,
      drawingId,
      download === "true",
  ...
  async uploadItemDrawing(
    ...
    return this.itemsService.uploadDrawing(
      req.user.tenantId,
      userId,
      itemId,
      drawingData,
  ...
  @Post("items/:id/drawings/:drawingId/links")
  async linkItemDrawingToItems(
    @Request() req: any,
    @Param("id") itemId: string,
    @Param("drawingId") drawingId: string,
    @Body() body: any,
    ...
    const userId = req.user?.userId || req.user?.sub || req.user?.id;
    return this.itemsService.linkDrawingToItems(
      req.user.tenantId,
      userId,
      itemId,
      drawingId,
  ...
  async updateItemDrawing(
    ...
    return this.itemsService.updateDrawing(
      req.user.tenantId,
      itemId,
      drawingId,
      drawingData,
  ...
  async transitionItemDrawing(
    ...
    const userId = req.user?.userId || req.user?.sub || req.user?.id;
    return this.itemsService.transitionDrawing(
      req.user.tenantId,
      userId,
      itemId,
      drawingId,
  ...
  async getItemDrawingImpact(
    ...
    return this.itemsService.getDrawingImpact(
      req.user.tenantId,
      itemId,
      drawingId,
    );
  ...
  @Roles("SUPER_ADMIN", "SUPER ADMIN", "SUPERADMIN")
  async deleteItemDrawing(
    @Request() req: any,
    @Param("id") itemId: string,
    @Param("drawingId") drawingId: string,
  ) {
    return this.itemsService.deleteDrawing(
      req.user.tenantId,
  ...
  async addItemVendor(
    ...
    return this.itemsService.addItemVendor(
      req.user.tenantId,
      req.user.userId,
      itemId,
      body,
  ...
  async updateItemVendor(
    ...
    return this.itemsService.updateItemVendor(
      req.user.tenantId,
      req.user.userId,
      itemId,
      vendorId,
  ...
  async deleteItemVendor(
    @Request() req: any,
    @Param("id") itemId: string,
    @Param("vendorId") vendorId: string,
  ) {
    return this.itemsService.deleteItemVendor(
      req.user.tenantId,
      itemId,
      vendorId,
    );
