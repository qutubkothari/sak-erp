...
export class VendorsService {
  ...
  private buildVendorPayload(data: any, existingVendor?: any) {
    ...
    return {
      ...
      metadata: {
        ...
        isGstUnregistered: data?.isGstUnregistered !== undefined
          ? Boolean(data.isGstUnregistered)
          : Boolean(metadata.isGstUnregistered),
        bankName,
        bankAccountNumber,
        bankIfscCode,
        bankBranch,
  ...
  private hydrateVendor(vendor: any) {
    ...
    return {
      ...
      is_gst_unregistered: metadata.isGstUnregistered === true,
