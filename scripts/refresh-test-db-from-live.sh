...
node /var/www/sak-erp/scripts/assert-deployment-target.cjs \
  --target live --app-root /var/www/sak-erp \
  --api-process sak-api --web-process sak-web \
  --api-port 4000 --web-port 3000 --public-url https://erp.saifseas.com
node /var/www/sak-erp-test/scripts/assert-deployment-target.cjs \
  --target test --app-root /var/www/sak-erp-test \
  --api-process sak-api-test --web-process sak-web-test \
  --api-port 4001 --web-port 3001 --public-url https://mizantra.saksolution.com
